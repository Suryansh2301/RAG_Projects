...
CHUNK_SIZE = 800 # or 800
CHUNK_OVERLAP = 150 # or 150
...
# Lightweight local reranker - ~80MB, fits comfortably in low-memory
# deployments (e.g. Render Free/Starter 512MB), English-only.
...
LLM_MODEL_ID = os.getenv("LLM_MODEL_ID", "Qwen/Qwen3-8B") # Option B: gemini-3.6-flash
